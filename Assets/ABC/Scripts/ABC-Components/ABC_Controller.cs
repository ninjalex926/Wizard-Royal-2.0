...
public class ABC_Controller : MonoBehaviour {
    ...
    public class Weapon {
        ...
        public class WeaponObj {
            ...
            /// <summary>
            /// Forward offset of the weapon Enabled position 
            /// </summary>
            [Tooltip("Forward offset of the weapon Enabled position ")]
            public float weaponEnabledPositionForwardOffset;

            /// <summary>
            /// Right offset of the weapon Enabled position
            /// </summary>
            [Tooltip("Right offset of the weapon Enabled position")]
            public float weaponEnabledPositionRightOffset;
            ...
            /// <summary>
            /// Forward offset of the weapon Disabled position 
            /// </summary>
            [Tooltip("Forward offset of the weapon Disabled position ")]
            public float weaponDisabledPositionForwardOffset;

            /// <summary>
            /// Right offset of the weapon Disabled position
            /// </summary>
            [Tooltip("Right offset of the weapon Disabled position")]
            public float weaponDisabledPositionRightOffset;
            ...
            /// </summary>
            private ABC_AnimationRunner weaponObjAnimationRunner = null;
            ...
            public IEnumerator ToggleGraphic(ABC_IEntity Originator, WeaponState WeaponToggleType, bool QuickToggle = false) {
                ...
                switch (WeaponToggleType) {
                    ...
                    case WeaponState.Equip:
                        ...
                        positionForwardOffset = this.weaponEnabledPositionForwardOffset;
                        positionRightOffset = this.weaponEnabledPositionRightOffset;
                    ...
                    case WeaponState.UnEquip:
                        ...
                        positionForwardOffset = this.weaponDisabledPositionForwardOffset;
                        positionRightOffset = this.weaponDisabledPositionRightOffset;
                ...
                switch (startingPosition) {
                    ...
                    case WeaponPositionType.OnSelfTag:
                        GameObject onSelfTagObj = ABC_Utilities.TraverseObjectForTag(meTransform.gameObject, positionOnTag);
                ...
                graphicObj.transform.rotation = parentObject.transform.rotation * Quaternion.Euler(rotation);
            ...
            public ABC_AnimationRunner GetAnimationRunner() {

                //try and recieve animation runner if null
                if (this.weaponObjAnimationRunner == null && this.weaponPool != null)
                    this.weaponObjAnimationRunner = this.weaponPool.GetComponentInChildren<ABC_AnimationRunner>();
                ...
                if (this.GetAnimator() != null && this.weaponPool != null && this.weaponObjAnimationRunner == null)
                    this.weaponObjAnimationRunner = this.weaponPool.AddComponent<ABC_AnimationRunner>();
        ...
        public bool useWeaponAnimations = false;
        ...
        private void StartAndStopAnimationRunner(WeaponState ToggleType, ABC_AnimationRunner AnimationRunner, WeaponAnimationType AnimationType = WeaponAnimationType.StartAndStop) {
            ...
            switch (ToggleType) {
                case WeaponState.Equip:
                    ...
                    animationDuration = this.weaponEnableAnimationRunnerClipDuration;
                ...
                case WeaponState.UnEquip:
                    ...
                    animationDuration = this.weaponDisableAnimationRunnerClipDuration;
                ...
                case WeaponState.Drop:
                    ...
                    animationDuration = this.weaponDropAnimationRunnerClipDuration;
                ...
                case WeaponState.Reload:
                    ...
                    animationDuration = this.weaponReloadDuration;
                ...
                case WeaponState.Block:
                    ...
                    animationDuration = this.weaponBlockAnimationRunnerClipDuration;
                ...
                case WeaponState.BlockReaction:
                    ...
                    animationDuration = this.weaponBlockReactionAnimationRunnerClipDuration;
                ...
                case WeaponState.AttackReflected:
                    ...
                    animationDuration = this.weaponMeleeAttackReflectedAnimationRunnerClipDuration;
                ...
                case WeaponState.Parry:
                    ...
                    animationDuration = this.weaponParryAnimationRunnerClipDuration;
                ...
                case WeaponState.Equip:
                    ...
                    if (this.enableAbilitiesWhenEquipped) {
                        ...
                        if (this.disableAllOtherAbilitiesNotListed) {
                            ...
                            foreach (int abilityID in Originator.AllAbilities.Where(a => this.enableAbilityIDs.Contains(a.abilityID) == false).Select(a => a.abilityID).ToList()) {
                    ...
                    if (this.disableAbilitiesWhenEquipped) {
                        ...
                        if (this.enableAllOtherAbilitiesNotListed) {
                            ...
                            foreach (int abilityID in Originator.AllAbilities.Where(a => this.disableAbilityIDs.Contains(a.abilityID) == false).Select(a => a.abilityID).ToList()) {
                                Originator.EnableAbility(abilityID);
                            }
                ...
                case WeaponState.Equip:
                    ...
                    if (this.enableAbilityGroupsWhenEquipped) {
                        ...
                        if (this.disableAllOtherGroupsNotListed) {
                            ...
                            foreach (int groupID in Originator.AllAbilityGroups.Where(g => this.enableAbilityGroupIDs.Contains(g.groupID) == false).Select(g => g.groupID).ToList()) {
        ...
        public List<ABC_AnimationRunner> GetWeaponAnimationRunners() {

            List<ABC_AnimationRunner> retVal = new List<ABC_AnimationRunner>();

            //Load the weapon graphics
            if (this.weaponGraphics != null && this.weaponGraphics.Count() > 0) {
                foreach (WeaponObj weaponGraphic in this.weaponGraphics) {

                    ABC_AnimationRunner AniRunner = weaponGraphic.GetAnimationRunner();
        ...
        public IEnumerator ToggleWeapon(ABC_IEntity Originator, WeaponState WeaponToggleType, bool QuickToggle = false) {
            ...
            if (this.useWeaponAnimations == true) {
                ...
                // start animator
                if (animatorParameter != "" && QuickToggle == false) {
        ...
        public bool ActivateParryHandler(ABC_IEntity Originator, ABC_IEntity ParriedEntity, AbilityType AbilityType, Vector3 AbilityHitPoint = default(Vector3), bool IgnoreWeaponParry = false) {
            ...
            //Stagger the enemy
            ParriedEntity.HitRestrictAbilityActivation();
                        ...
                        foreach (BlockStatModifications statMod in this.weaponBlockStatModifications) {
                            ...
                            switch (statMod.arithmeticOperator) {
                                case ArithmeticIncrDecrOperators.Increase:
                                    ...
                                    if (statMod.statIntegrationType == ABCIntegrationType.ABC)
                                        Originator.AdjustStatValue(statMod.statName, statModification);
                                    else if (statMod.statIntegrationType == ABCIntegrationType.GameCreator)
                                        Originator.AdjustGCStatValue(statMod.statName, statModification);
                            ...
                            switch (statMod.arithmeticOperator) {
                                case ArithmeticIncrDecrOperators.Increase:
                                    ...
                                    if (statMod.statIntegrationType == ABCIntegrationType.ABC)
                                        ...
                                        Originator.AdjustGCStatValue(statMod.statName, -statMod.finalStatValueModification);
        ...
        public float ActivateBlockHandler(ABC_IEntity Originator, ABC_IEntity BlockedEntity, AbilityType AbilityType, Vector3 AbilityHitPoint = default(Vector3), bool InterruptWeaponBlock = false, bool ReduceWeaponBlockDurability = true) {
            ...
            } else if (this.weaponBlockTurnToAbilityHitPoint && AbilityHitPoint != default(Vector3)) {
                //If set to turn to ability hit point and hit point is not default then turn to the direction of where the attack came in 
            ...
            if (Originator.blockDurability <= 0f) {
                ...
                Originator.PreventWeaponBlockingForDuration(7f);
                Originator.StopWeaponBlocking();
    ...
    public class AbilityGroup {
        ...
        /// <param name="AnimationRunner">The ABC Animation Runner component to manage the animation clip</param>
        private void StartAnimationRunner(AbilityGroupAnimationState State, ABC_AnimationRunner AnimationRunner) {
        ...
        private void EndAnimationRunner(AbilityGroupAnimationState State, ABC_AnimationRunner AnimationRunner, float Delay = 0f) {
        ...
        private List<ABC_Ability> GetOriginatorsAbilitiesAssignedToMyGroup(ABC_IEntity Originator) {
            ...
            return Originator.AllAbilities.Where(item => item.allowAbilityGroupAssignment == true && item.assignedAbilityGroupIDs.Contains(this.groupID)).ToList();
        ...
        private List<Weapon> GetOriginatorsWeaponsAssignedToMyGroup(ABC_IEntity Originator) {
            ...
            return Originator.AllWeapons.Where(item => item.allowWeaponGroupAssignment == true && item.assignedGroupIDs.Contains(this.groupID)).ToList();
    ...
    public class AIRule {
        ...
        /// <summary>
        ///  The minimum cooldown of AI Blocking
        /// </summary>
        [Tooltip("The minimum cooldown of AI Blocking")]
        [Range(0f, 100f)]
        public float AIBlockCooldownMin = 5f;

        /// <summary>
        ///  The maximum cooldown of AI Blocking
        /// </summary>
        [Tooltip("The maximum cooldown of AI Blocking")]
        [Range(0f, 100f)]
        public float AIBlockCooldownMax = 20f;
        ...
        private int NumberOfSurroundingTagsActivating(Vector3 SurroundingPosition, float Range) {
            ...
            foreach (ABC_IEntity Obj in surroundingTags.Where(a => a.gameObject.activeInHierarchy == true && ABC_Utilities.ObjectHasTag(a.gameObject, this.AIAreaActivationLimitTags))) {
        ...
        /// <summary>
        /// Returns a bool indicating if the target provided meets the conditions set for the ability to activate. Example: If target health is > 50% and is effected by poison
        /// </summary>
        ...
        public bool CorrectTargetConditions(GameObject Target, ABC_IEntity Originator) {
            ...
            if ((this.AITags.Count > 0 && ABC_Utilities.ObjectHasTag(Target.gameObject, this.AITags) == false) || (this.AITargets.Count > 0 && this.AITargets.Contains(Target.gameObject) == false))
                return false;
            ...
            if (this.AIAreaActivationLimit == true && this.NumberOfSurroundingTagsActivating(targetEntity.transform.position, this.AIAreaActivationLimitRange) > this.AIAreaActivationLimitMax)
                return false;
            ...
            switch (this.AIAbilityTarget) {
                ...
                case AIRuleTarget.Nearest:
                    ...
                    foreach (ABC_IEntity AITarget in PotentialTargets) {
                        ...
                        if (iEntity.HasABCStateManager() == true && this.AINearestTags.Count > 0 & ABC_Utilities.ObjectHasTag(AITarget.gameObject, this.AINearestTags) || this.AINearestTargets.Count > 0 && this.AINearestTargets.Contains(AITarget.gameObject))
    ...
    /// </summary>
    public ABC_ExportedAbilities importAbilitiesObj;
    ...
    /// <summary>
    /// show  ability list in window
    /// </summary>
    public bool showAbilityListInWindow = true;
    ...
    /// <summary>
    /// If true then whilst AI is enabled abilities can't be activated via key/button triggers
    /// </summary>
    [Tooltip("If true then whilst AI is enabled abilities can't be activated via key/button triggers")]
    public bool aiRestrictAbilityTriggers = false;
    ...
    /// </summary>
    [Tooltip("The interval before destination is cleared so a new one can be found, if 0 then this functionality is turned off")]
    ...
    public float currentMaxMana {
        get {
            ...
            if (this.manaIntergrationType == ABCIntegrationType.ABC)
                return this.maxMana;
            else
    ...
    public float currentMaxBlockDurability {
        get {
            ...
            if (this.blockDurabilityIntergrationType == ABCIntegrationType.ABC)
    ...
    /// <summary>
    /// The object indicator which shows when selecting a world position to activate ability like in 'ability before target' mode and the indicator is in abillity range
    /// </summary>
    [Tooltip("Object that shows when in range")]
    public ABC_GameObjectReference abilityWorldTargetIndicator;

    /// <summary>
    /// The object indicator which shows when selecting a world position to activate ability in 'ability before target' mode and the indicator is out the abillity range
    /// </summary>
    [Tooltip("Object that shows when out of range")]
    public ABC_GameObjectReference abilityWorldTargetOutRangeIndicator;
    ...
    /// </summary>
    private List<ABC_Ability> activeMeleeAbilities = new List<ABC_Ability>();
    ...
    /// <summary>
    /// stores the ability world target indicator (1 per ABC_Controller) 
    /// </summary>
    public GameObject abilityWorldTargetIndicatorObj;

    /// <summary>
    /// The default size of the world target indicator
    /// </summary>
    public Vector3 abilityWorldTargetIndicatorDefaultSize = new Vector3(1f, 1f, 1f);

    /// <summary>
    /// stores the ability world target indicator when out of range (1 per ABC_Controller) 
    /// </summary>
    public GameObject abilityWorldTargetOutRangeIndicatorObj;

    /// <summary>
    /// The default size of the world target indicator when out of range
    /// </summary>
    public Vector3 abilityWorldTargetOutRangeIndicatorDefaultSize = new Vector3(1f, 1f, 1f);

    /// <summary>
    /// Bool which determines if the crosshair override is currently active
    /// </summary>
    public bool showCrossHairOverride = false;
    ...
    public void ClearAllPools() {
        ...
        foreach (ABC_Ability a in Abilities) {
            a.ClearObjectPools();
        }
        ...
        // clear current ability out of range indicator 
        if (this.abilityWorldTargetOutRangeIndicatorObj != null) {
            Destroy(this.abilityWorldTargetOutRangeIndicatorObj);
        }
    ...
    public void CreatePools() {
        ...
        // if were using ability before target indicator then create one if it doesn't exist

        if (this.abilityWorldTargetIndicator.GameObject != null) {

            this.abilityWorldTargetIndicatorObj = (GameObject)(Instantiate(abilityWorldTargetIndicator.GameObject));
            this.abilityWorldTargetIndicatorObj.name = meTransform.name.ToString() + "_ABC_AbBeforeTargetIndicator";
            this.abilityWorldTargetIndicatorDefaultSize = abilityWorldTargetIndicatorObj.transform.localScale;
        ...
        if (this.abilityWorldTargetOutRangeIndicator.GameObject != null) {

            this.abilityWorldTargetOutRangeIndicatorObj = (GameObject)(Instantiate(abilityWorldTargetOutRangeIndicator.GameObject));
            this.abilityWorldTargetOutRangeIndicatorObj.name = meTransform.name.ToString() + "_ABC_AbBeforeTargetOutRangeIndicator";
            this.abilityWorldTargetOutRangeIndicatorDefaultSize = abilityWorldTargetOutRangeIndicatorObj.transform.localScale;


            ABC_Utilities.PoolObject(this.abilityWorldTargetOutRangeIndicatorObj);
        }
    ...
    public IEnumerator ToggleIdleMode(bool Enabled, bool Instant = false) {
        ...
        if (Enabled == true && this.inIdleMode == false) {
           ...
           yield return StartCoroutine(SwitchIdleMode(Instant)); // else if in idle mode and we are toggling into idle mode
        }
    ...
    public List<string> GetAllAbilityNames(bool EnabledOnly = false) {
        ...
        if (EnabledOnly)
            return Abilities.Where(ability => ability.abilityEnabled == true).Select(ability => ability.name).ToList();
        else
            return Abilities.Select(ability => ability.name).ToList();
    ...
    public ABC_Ability FindAbility(int AbilityID) {
        ...
        return this.Abilities.Where(a => a.abilityID == AbilityID).FirstOrDefault();
    ...
    public ABC_Ability FindAbility(string AbilityName) {
        ...
        return this.Abilities.Where(a => a.name == AbilityName).FirstOrDefault();
    ...
    public int GetAbilityNextAvaliableComboID(int AbilityID) {
        ...
        List<ABC_Ability> potentialComboAbilities = this.Abilities.Where(a => a.abilityEnabled == true && a.abilityCombo == true && a.keyInputType == ability.keyInputType).ToList();
    ...
    public int GetAbilityNextAvaliableComboID(string AbilityName) {
    ...
    public bool CanActivateAbilitiesFromTriggers() {
        ...
        if (this.enableAI == true && this.aiRestrictAbilityTriggers == true)
            return false;
        else
            return true; 
    ...
    public Weapon FindWeapon(int WeaponID) {
        ...
        retVal = this.Weapons.Where(w => w.weaponID == WeaponID).FirstOrDefault();
    ...
    public Weapon FindWeapon(string WeaponName) {
        ...
        retVal = this.Weapons.Where(w => w.weaponName == WeaponName).FirstOrDefault();
    ...
    public int NoOfEnabledWeapons() {
        ...
        return this.Weapons.Where(w => w.IsEnabled() == true).ToList().Count();
    ...
    public IEnumerator EquipNextWeapon(bool QuickToggle = false) {
        ...
        if (this.Weapons.Count < 2 || this.Weapons.Count(w => w.IsEnabled()) < 2)
            yield break;
        ...
        if (this.CurrentEquippedWeapon != null)
            currentIndex = this.Weapons.FindIndex(w => w == this.CurrentEquippedWeapon) + 1;

        //Record next enabled weapon in list
        for (int i = currentIndex; i <= Weapons.Count; i++) {
            ...
            if (Weapons[i].IsEnabled() && Weapons[i].enableWeaponOnCycle == true) {
                weaponToEnable = Weapons[i];
                break;
            }
    ...
    /// </summary>
    /// <returns>List of ABC Animation Runner Components</returns>
    public List<ABC_AnimationRunner> GetCurrentEquippedWeaponAnimationRunners() {
    ...
    public void EnableAbilitiesAfterEvent(int AbilityID, AbilityEvent AbilityEvent) {
        ...
        switch (AbilityEvent) {
            case AbilityEvent.Activation:
                abilitiesToEnable = this.Abilities.Where(item => item.enableAfterEvent == true && item.enableAfterAbilityIDsActivated.Contains(AbilityID)).ToList();
                break;
            case AbilityEvent.Collision:
                abilitiesToEnable = this.Abilities.Where(item => item.enableAfterEvent == true && item.enableAfterAbilityIDsCollide.Contains(AbilityID)).ToList();
                break;
        }
    ...
    public void AddToActiveMeleeAbilities(ABC_Ability Ability) {
        
        this.activeMeleeAbilities.Add(Ability);
    ...
    public void RemoveFromActiveMeleeAbilities(ABC_Ability Ability) {
  
        if (this.activeMeleeAbilities.Contains(Ability))
    ...
    public bool IsActivatingAbility() {
        ...
        if (this.activatingAbilities.Count > 0)
            return true;
        else
            return false; 
    }
    ...
    public void InterruptAbilityActivation(bool HitInterrupted = false) {
        ...
        foreach (ABC_Ability meleeAbility in activeMeleeAbilities)
    ...
    private IEnumerator InitialiseComponent(bool GameReload = false, int WeaponEquipID = -1){
        ...
        //reset current equipped weapon if not game reload
        if (GameReload == false)
            this.CurrentEquippedWeapon = null;
        ...
        InvokeRepeating("ClearAINavigationDestination", this.clearDestinationInterval, this.clearDestinationInterval);
    ...
    private IEnumerator SetupWeapons(int EquipWeaponID = -1, bool QuickToggle = true) {
        ...
        // disable all weapons instantly 
        foreach (Weapon weapon in Weapons.Where(w => w.IsEnabled())) {
        ...
        if (this.CurrentEquippedWeapon == null || this.CurrentEquippedWeapon.IsEnabled() == false || EquipWeaponID > -1) {
            ...
            if (this.CurrentEquippedWeapon == null)
                this.CurrentEquippedWeapon = Weapons.Where(w => w.IsEnabled()).FirstOrDefault();
        }
        ...
        else // else enable the weapon instantly 
    ...
    private IEnumerator SetupScrollAbilities() {
        ...
        if (Abilities.Where(a => a.IsAnEnabledScrollAbility()).Count() == 0)
            yield break;


        // disable all current scroll ability
        foreach (ABC_Ability ability in Abilities.Where(a => a.IsAScrollAbility())) {
        ...
        if (this.CurrentScrollAbility == null || this.CurrentScrollAbility.IsAnEnabledScrollAbility() == false)
            this.CurrentScrollAbility = Abilities.Where(a => a.IsAnEnabledScrollAbility()).FirstOrDefault();
    ...
    private bool ButtonPressed(ControllerButtonPressState State, ControllerButtonPressType PressType = ControllerButtonPressType.Press) {
        ...
        if (pressType == ControllerButtonPressType.Press) {
            ...
            if (scrollWheelUpIncluded == true && Input.GetAxis("Mouse ScrollWheel") > 0)
                return true;

            //If scrollwheel down included and being 'pressed' then return true 
            if (scrollWheelDownIncluded == true && Input.GetAxis("Mouse ScrollWheel") < 0)
                return true;
            ...
            if (inputType == InputType.Key && Input.GetKey(key))
                return true;


            // if input type is button and the configured button is being held down return true
            if (inputType == InputType.Button && Input.GetButton(button))
                return true;
    ...
    private void RandomlySwapAbilityPositions() {
        ...
        for (int i = 0; i < Abilities.Count(); i++) {
            ...
            //retrieve ability 
            ABC_Ability ability = Abilities[i];
            ...
            swappableAbilityList = Abilities.Where(a => a != ability && a.randomlySwapAbilityPosition == true && a.abilityEnabled == true && a.scrollAbility == false && (a.keyInputType == InputType.Key && a.key == ability.key || a.keyInputType == InputType.Button && a.keyButton == ability.keyButton)).ToList();
            ...
            int originalIndex = Abilities.FindIndex(a => a == ability);
            int swapIndex = Abilities.FindIndex(a => a == abilityToSwap);

            Abilities[swapIndex] = ability;
            Abilities[originalIndex] = abilityToSwap;
    ...
    private void AbilityWatcher() {
        ...
        foreach (ABC_Ability ability in Abilities) {
    ...
    private void AutoCastHandler() {
        ...
        // get all potential targets in a big range if the intermission time has passed since we last retrieved potential targets
        if (Time.time - this.timeOfLastAIPotentialTargetRetrieval >= this.aiPotentialTargetRetrievalIntermission+Random.Range(0f, 0.8f)) { // random range used so overlap spheres do not all happen at once causing fps drops
        ...
        foreach (AIRule rule in enabledAIRules.Where(a => a.AIActive == true)) {
            ...
            switch (rule.selectedAIAction) {
                case AIRule.AIAction.ActivateAbility:
                    ...
                    //If ability is combo blocked then find the next avaliable comboID
                    if (ability.IsComboBlocked(meEntity, true)) {
                        ability = this.FindAbility(meEntity.GetAbilityNextAvaliableComboID(ability.abilityID));
                    ...
                    // if ability doesn't exist or isnt ready then continue to the next rule in the loop
                    if (this.ActivateAbility(ability, true) == false) {
                ...
                case AIRule.AIAction.ActivateBlocking:
                    ...
                    StartCoroutine(this.ActivateAutoWeaponBlock(Random.Range(rule.AIBlockDurationMin, rule.AIBlockDurationMax), Random.Range(rule.AIBlockCooldownMin, rule.AIBlockCooldownMax)));
            ...
            //Record the time we last did an AI Action
            this.timeOfLastAIAction = Time.time;

            //Rereoll the intermission to get a new random number between the minimum and maximum 
            this.AICheckIntermission = Random.Range(this.minimumAICheckIntermission, this.maximumAICheckIntermission);
    ...
    private void AutoTargetHandler() {
        ...
        foreach (ABC_IEntity targ in ABC_Utilities.GetAllABCEntitiesInRange(meTransform.position, targetSelectRange).ToList()) {
            ...
            if (this.autoTargetTagOnly == true && ABC_Utilities.ObjectHasTag(targ.gameObject, autoTargetTags) == false)
                continue;
    ...
    private void TargetDeselectHandler() {
        ...
        // check if our target is still active and in range and has health. if not turn off the target select 
    ...
    private void SoftTargetHandler() {
        ...
        if (softTarget != null && (softTarget.activeInHierarchy == false || InRange(softTarget, targetSelectRange) == false)) {
    ...
    private void TabTargetsHandler() {
        ...
        while (counter != currentTargetIndex) {
            ...
            if (this.tabTargetTagOnly == true) {
                ...
                if (ABC_Utilities.ObjectHasTag(target.gameObject, tabTargetTags) == false) 
    ...
    private void CheckScrollAbilityKeyPress() {
        ...
        for (int i = 0; i < Abilities.Count; i++) {
            if (Abilities[i].IsAnEnabledScrollAbility() && Abilities[i].ScrollQuickKeyPressed()) {
                StartCoroutine(this.JumpToScrollAbility(Abilities[i].abilityID));
                break;
            }
    ...
    private void CheckCrossHairOverrideKeyPress() {
        ...
        if (this.ButtonPressed(ControllerButtonPressState.ShowCrossHair, ControllerButtonPressType.Hold)) {

            // make crosshair appear by setting value to true (OnGui does the rest) 
            showCrossHairOverride = true;


            // if not showing Aesthetic then we done here 
            if (useCrossHairOverrideAesthetics == false)
                return;
    ...
    private void AINavigationWanderHandler() {
        ...
        if (this.navAIEnabled == false || this.meNavAgent.enabled == false || this.meTransform.gameObject.activeInHierarchy == false || this.IsActivatingAbility() == true)
            return;
    ...
    private void AINavigationHandler() {
        ...
        if (this.navAIEnabled == false  || meNavAgent.enabled == false || meTransform.gameObject.activeInHierarchy == false || this.IsActivatingAbility() == true)
            return;
       ...
       //If destination has not been found then end here
        ...
        if (this.AINavigationEntityInSight(this.currentNavAIDestination) == false || Vector3.Distance(this.currentNavAIDestination.transform.position, this.meTransform.position) > this.destinationSearchRadius || this.currentNavAIDestination.gameObject.activeInHierarchy == false) {
            ...
            if (this.navAIDestinationSet == true) {
                ...
                //Toggle to idle mode when destination set (if enabled)
    ...
    private void AINavigationTurnToDestination() {
        ...
        if (this.navAIDestinationSet == true && this.alwaysFaceDestination) {
    ...
    private void AINavigationRotateAroundDestination() {
        ...
        //If not active then end manager here
        if (this.navAIEnabled == false || this.navAIRotateAroundDestination == false || meTransform.gameObject.activeInHierarchy == false || this.IsActivatingAbility() == true)
            return;
    ...
    /// </summary>
    private void AINavigationMoveAwayFromDestination() {

        //If not active then end manager here
        if (this.navAIEnabled == false || this.navAIChangeDestinationMovingAway == false || this.currentNavAIDestination == null || meTransform.gameObject.activeInHierarchy == false || this.IsActivatingAbility() == true)
            return;


        //If we are close to the stopping distance then end the moving away 
        if (Vector3.Distance(this.meTransform.position, this.currentNavAIDestination.position) >= this.meNavAgent.stoppingDistance - 2.5) {
    ...
    /// </summary>
    private void AINavigationStopDestinationBehaviours() {
    ...
    private bool AINavigationEntityInSight(Transform Entity) {
        ...
        if (dot >= 0.3 || this.currentNavAIDestination == true) {
    ...
    /// </summary>
    private void FindAINavigationDestination() {

        if (this.currentNavAIDestination != null || this.navAIEnabled == false || this.IsActivatingAbility() == true)
            return;

        // get all objects in a  range
        List<ABC_IEntity> potentialAINavDestinations = ABC_Utilities.GetAllABCEntitiesInRange(meTransform.position, this.destinationSearchRadius);
        ...
        foreach (ABC_IEntity potDestination in potentialAINavDestinations) {
            ...
            if (ABC_Utilities.ObjectHasTag(potDestination.gameObject, this.destinationTag) == false)
                continue;
    ...
    private bool AINavigationWithinStoppingDistance() {
        ...
        if (this.meNavAgent.remainingDistance <= this.meNavAgent.stoppingDistance && (this.meNavAgent.hasPath == false || (this.stopDistanceCheckVelocity == false || this.stopDistanceCheckVelocity == true && this.meNavAgent.velocity.sqrMagnitude == 0f)))
            return true;
    ...
    void GetTarget(string ClickType, TargetSelectType SelectType = TargetSelectType.Mouse) {
        ...
        if (SelectType == TargetSelectType.Mouse)
            ray = meEntity.Camera.ScreenPointToRay(Input.mousePosition);
        ...
        RaycastHit worldHit = hit.Where(n => n.transform.gameObject != meTransform.gameObject && n.transform.root.gameObject.name.Contains("ABC*_") == false).FirstOrDefault();
        ...
        else if (ClickType.ToUpper() == "CLICK" && this.clickForTarget == true)
        ...
        if (targetHit != null && (this.selectTargetTagOnly == false || this.selectTargetTagOnly == true && ABC_Utilities.ObjectHasTag(targetHit.transform.gameObject, this.selectTargetTags))) {
        ...
        // no longer waiting on mouse target 
    ...
    public void ShowTargetIndicator(bool Enabled, GameObject TargetObject = null) {
    ...
    private IEnumerator NextScrollAbility(bool ActivateAesthetic = true)
    {
        ...
        if (CurrentScrollAbility != null)
            currentIndex = Abilities.FindIndex(a => a == CurrentScrollAbility) + 1;

        //Record next scroll ability
        for (int i = currentIndex; i <= Abilities.Count; i++)
        {
            ...
            if (Abilities[i].IsAnEnabledScrollAbility())
            {
                this.CurrentScrollAbility = Abilities[i];
    ...
    /// <param name="AnimationRunner">The ABC Animation Runner component to manage the animation clip</param>
    private void StartAnimationRunner(ControllerAnimationState State, ABC_AnimationRunner AnimationRunner){
    ...
    /// <param name="AnimationRunner">The ABC Animation Runner component to manage the animation clip</param>
    /// <param name="Delay">(Optional) Delay before animation ends</param>
    private void EndAnimationRunner(ControllerAnimationState State, ABC_AnimationRunner AnimationRunner, float Delay = 0f){
    ...
    void Update() {
        ...
        if (this.inIdleMode == false) {
            ...
            if (this.showCrossHairOnKey == true)
            ...
            //run target select handler if enabled or auto target select is true and interval is less then 1 (so it is using update)
            if ((this.targetSelectType != TargetSelectType.None && this.targetSelectInterval == 0f))
    ...
    /// <summary>
    /// Exports Abilities set for the entity
    /// </summary>
    public void ExportAbilities() {
        ...
        // create an empty object with the new exported abilities script 
        ABC_ExportedAbilities exportedAbilities = ScriptableObject.CreateInstance<ABC_ExportedAbilities>();
        string fullPath = UnityEditor.EditorUtility.SaveFilePanel("Save Ability", "Assets", "New Ability Export", "asset");
        string basePath = fullPath.Replace(Application.dataPath, "Assets");
        UnityEditor.AssetDatabase.CreateAsset(exportedAbilities, basePath);

        foreach (ABC_Ability a in Abilities) {
            if (a.enableExport == true) {
                // add ability to export script 

                ABC_Ability newAbility = new ABC_Ability();
                JsonUtility.FromJsonOverwrite(JsonUtility.ToJson(a), newAbility);
                exportedAbilities.ExportedAbilities.Add(newAbility);
    ...
    /// Imports Abilities
    /// </summary>
    public void ImportExportedAbilities() {


        if (importAbilitiesObj == null) {
            this.AddToDiagnosticLog("Unable to import at this time. No Import Object has been entered");
            return;
        }

       StartCoroutine(this.ImportAbilities(importAbilitiesObj.ExportedAbilities.Where(a => a.enableImport == true).ToList(), false, false));

        // remove script from the load 
        importAbilitiesObj = null;

    }


    /// <summary>
    /// Imports abilites to the entity from the ability objects provided. This is a direct import and not a copy (ID will remain)
    /// </summary>
    /// <param name="AbilitiesToImport">List of ability objects to import</param>
    /// <param name="EnableIfExists">If true then if ability already exists then it will be enabled</param>
    /// <param name="RunSetup">If true then the setup function will be called</param>
    public IEnumerator ImportAbilities(List<ABC_Ability> AbilitiesToImport, bool EnableIfExists = true, bool RunSetup = true) {

        //If list is null or is empty then end here
        if (AbilitiesToImport.Count == 0 || AbilitiesToImport == null)
            yield break; 

        foreach (ABC_Ability abilityToCopy in AbilitiesToImport) {

            //If group already exists then continue to next
            if (this.FindAbility(abilityToCopy.abilityID) != null) {

                //If set to enable if exists then enable ability 
                if (EnableIfExists)
                    this.EnableAbility(abilityToCopy.abilityID);

                //Continue to next ability in loop
                continue;
            }

            ABC_Ability newAbility = new ABC_Ability();
            JsonUtility.FromJsonOverwrite(JsonUtility.ToJson(abilityToCopy), newAbility);
            this.Abilities.Add(newAbility);
        }

        //Setup scroll abilities
        if (RunSetup)
            StartCoroutine(this.SetupWeaponsAndScrollAbilities());

    }

    /// <summary>
    /// Imports groups to the entity from the group objects provided. This is a direct import and not a copy (ID will remain)
    /// </summary>
    /// <param name="GroupsToImport">List of group objects to import</param>
    /// <param name="RunSetup">If true then the setup function will be called</param>
    public IEnumerator ImportGroups(List<ABC_Controller.AbilityGroup> GroupsToImport, bool RunSetup = true) {

        //If list is null or is empty then end here
        if (GroupsToImport.Count == 0 || GroupsToImport == null)
            yield break;

        foreach (ABC_Controller.AbilityGroup groupToCopy in GroupsToImport) {

            //If group already exists then continue to next
            if (this.FindAbilityGroup(groupToCopy.groupID) != null)
                continue; 

            ABC_Controller.AbilityGroup newGroup = new ABC_Controller.AbilityGroup();
            JsonUtility.FromJsonOverwrite(JsonUtility.ToJson(groupToCopy), newGroup);
            this.AbilityGroups.Add(newGroup);
        }

        //Setup ability groups
        if (RunSetup)
           this.SetupAbilityGroups(false);
    ...
    /// <summary>
    /// Imports weapons to the entity from the weapon objects provided. This is a direct import and not a copy (ID will remain)
    /// </summary>
    /// <param name="WeaponsToImport">List of weapon objects to import</param>
    /// <param name="EnableIfExists">If true then if weapon already exists then it will be enabled</param>
    /// <param name="RunSetup">If true then the setup function will be called</param>
    public IEnumerator ImportWeapons(List<ABC_Controller.Weapon> WeaponsToImport, bool EnableIfExists = true, bool RunSetup = true) {


        //If list is null or is empty then end here
        if (WeaponsToImport.Count == 0 || WeaponsToImport == null)
            yield break;


        foreach (ABC_Controller.Weapon weaponToCopy in WeaponsToImport) {

            if (this.FindWeapon(weaponToCopy.weaponID) != null) {

                //If set to enable if exists then enable weapon
                if (EnableIfExists)
                    this.EnableWeapon(weaponToCopy.weaponID, false, RunSetup);

                //Continue to next weapon in loop
                continue; 
            }

            ABC_Controller.Weapon newWeapon = new ABC_Controller.Weapon();
            JsonUtility.FromJsonOverwrite(JsonUtility.ToJson(weaponToCopy), newWeapon);
    ...
    /// <summary>
    /// Imports icon to the entity from the icon objects provided. This is a direct import and not a copy (ID will remain)
    /// </summary>
    /// <param name="IconsToImport">List of icon objects to import</param>
    /// <param name="RunSetup">If true then the setup function will be called</param>
    public IEnumerator ImportIcons(List<ABC_IconUI> IconsToImport, bool RunSetup = true) {


        //If list is null or is empty then end here
        if (IconsToImport.Count == 0 || IconsToImport == null)
            yield break;


        foreach (ABC_IconUI iconToCopy in IconsToImport) {

            if (this.FindIconUI(iconToCopy.iconID) != null)
                continue;

            ABC_IconUI newIcon = new ABC_IconUI();
            JsonUtility.FromJsonOverwrite(JsonUtility.ToJson(iconToCopy), newIcon);
            this.IconUIs.Add(newIcon);
        }
    ...
    public IEnumerator ABCBulkImport(List<ABC_Controller.AbilityGroup> GroupsToImport = null, List<ABC_Ability> AbilitiesToImport = null, List<ABC_Controller.Weapon> WeaponsToImport = null, List<ABC_IconUI> IconsToImport = null, bool EnableIfExists = true, int WeaponEquipID = -1, int ScrollAbilityEquipID = -1) {

        //Import all the ABC groups, abilities, weapons and icons, adding false to not run setup as we are doing that at end of function
        yield return this.ImportGroups(GroupsToImport, false);
        yield return this.ImportAbilities(AbilitiesToImport, true, false);
        yield return this.ImportWeapons(WeaponsToImport, true, false);
        yield return this.ImportIcons(IconsToImport, false);


        //If game is running then initialise component and equip any weapons or scroll abilities set in parameters
        if (Application.isPlaying) {
            yield return this.InitialiseComponent(true, WeaponEquipID);


            if (ScrollAbilityEquipID > -1)
                this.EquipScrollAbility(ScrollAbilityEquipID);
        }
