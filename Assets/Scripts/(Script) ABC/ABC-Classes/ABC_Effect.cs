...
public class Effect {
    ...
    /// <summary>
    /// This is populated by controller component when the effect is created
    /// </summary>
    ...
    [System.Serializable]
    public struct PotencyStatModifications {
    ...
    public void LogEffectText(ABC_IEntity Target, EffectAction Action,  ABC_IEntity Originator = null) {
        ...
        switch (Action) {
            case EffectAction.Add:
                ...
                text = this.ReplacePlaceHolders(this.effectLogText, Target, Originator);
            ...
            case EffectAction.Remove:
                ...
                text = this.ReplacePlaceHolders(this.removeEffectLogText, Target, Originator);
            ...
            case EffectAction.OutOfRange:
                ...
                text = Target.gameObject.name + " is not in range of " + this.abilityName + ". " + this.effectName + " did not activate";
            ...
            case EffectAction.NoEffect:
                ...
                text = this.abilityName + " " + this.effectName + " had no effect on " + Target.gameObject.name;
    ...
    public bool TargetInRange(ABC_IEntity Target, GameObject Projectile) {
        ...
        if (Vector3.Distance(Target.transform.position, Projectile.transform.position) <= range) {
         ...
         this.LogEffectText(Target, EffectAction.OutOfRange);
    ...
    public bool CanActivate(ABC_IEntity Target, GameObject ObjectHit = null) {
        ...
        if (this.effectIgnoreTagCheckEntity == true && ABC_Utilities.ObjectHasTag(Target.gameObject, this.effectIgnoreTag))
            return false;

        //If entity does not have a tag the effect requires then effect can't be added so return false
        if (this.effectRequiredTagCheckEntity == true && ABC_Utilities.ObjectHasTag(Target.gameObject, this.effectRequiredTag) == false)
            return false;
        ...
        if (ObjectHit != null) {
            ...
            if (this.effectIgnoreTagCheckObject == true && ABC_Utilities.ObjectHasTag(ObjectHit, this.effectIgnoreTag))
                return false;

            //If object hit does not have a tag the effect requires then effect can't be added so return false
            if (this.effectRequiredTagCheckObject == true && ABC_Utilities.ObjectHasTag(ObjectHit, this.effectRequiredTag) == false)
                return false;
        }
    ...
    public IEnumerator Activate(ABC_IEntity Target, ABC_IEntity Originator, AbilityType AbilityType, Vector3 HitPoint = default(Vector3), GameObject Projectile = null) {
        ...
        while (repeatCount <= maxRepeats) {
            ...
            foreach (ABC_IEntity entity in entitiesToActivateOn) {
                    ...
                    float potencyValue = this.CalculatePotencyValue(entity, Originator);
                    ...
                    ABC_Utilities.mbSurrogate.StartCoroutine(ActivateTextGraphic(entity, EffectAction.Add, Originator));

                    // add to effect log
                    this.LogEffectText(entity, EffectAction.Add, Originator);
                }
                ...
                if (this.eventType == EffectEventType.Standard || this.eventType == EffectEventType.BothSimultaneously) {
                     switch (this.effectName.Trim()) {
                        ...
                        case "ShakeCamera":
                                ...
                                entity.ShakeCamera(float.Parse(this.miscellaneousProperty), potencyValue, float.Parse(this.miscellaneousAltProperty));
                                break;  
                        case "BulletTime":
                                ...
                                entity.ModifyGameSpeed(potencyValue, float.Parse(this.miscellaneousProperty));
                                break;
                        ...
                        case "AdjustAbilityAmmo":
                                ...
                                entity.AdjustAbilityAmmo(int.Parse(this.miscellaneousProperty), (int)potencyValue);
                                break;
                        ...
                        case "TriggerAbility":
                                ...
                                entity.TriggerAbility((int)potencyValue);
                                break;
                        ...
                        case "EnableAbility":
                                ...
                                // PotencyValue: ID of the ability to enable
                                entity.EnableAbility((int)potencyValue);
                                break;
                        case "DisableAbility":
                                // Effect: will disable an ability
                                // PotencyValue: ID of the ability to disable
                                entity.DisableAbility((int)potencyValue);
                                break;
                        case "EquipScrollAbilityByID":
                                // Effect: will 'equip' a scroll ability
                                // PotencyValue: ID of the scroll ability to 'equip'
                                entity.EquipScrollAbilityByID((int)potencyValue);
                                break;
                        ...
                        case "DisableCurrentScrollAbility":
                                ...
                                entity.DisableCurrentScrollAbility(bool.Parse(this.miscellaneousProperty), int.Parse(this.miscellaneousAltProperty));
                                break;
                        case "SwapCurrentScrollAbility":
                                ...
                                // MiscProperty: (Boolean) if true then the current scroll ability will only be disabled if x or greater scroll abilities are enabled
                                // AltMiscProperty: How many scroll abilities need to be currently enabled for the current one to be disabled (requires misc property to be true)
                                entity.SwapCurrentScrollAbility((int)(potencyValue), bool.Parse(this.miscellaneousProperty), int.Parse(this.miscellaneousAltProperty));
                                break;
                        case "AdjustGroupEnablePoint":
                                ...
                                entity.AdjustAbilityGroupEnablePoint(int.Parse(this.miscellaneousProperty), potencyValue);
                                break;
                        case "ToggleAbilityGroup":
                                ...
                                entity.ToggleAbilityGroup((int)(potencyValue), bool.Parse(this.miscellaneousProperty));
                                break;
                        case "Push":
                                ...
                                if (pushImpactPoint == Vector3.zero || HitPoint == Originator.transform.position)
                                    pushImpactPoint = Originator.transform.position + Originator.transform.forward * 2;
                       
                                entity.Push(potencyValue, pushImpactPoint, float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousAltProperty));
                                break;
                        case "PushSide":
                                ...
                                // AltMiscProperty: The amount of lift produced by the push
                                entity.PushSide(potencyValue, float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousAltProperty));
                                break;
                        case "PushRandomSide":
                                ...
                                // MiscProperty: How long it takes for entity to reach the side push distance
                                // AltMiscProperty: The amount of lift produced by the push
                                entity.PushRandomSide(potencyValue, float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousAltProperty));
                                break;
                        case "Lift":
                                ...
                                entity.Lift(potencyValue, float.Parse(this.miscellaneousProperty));
                                break;
                        case "Pull":
                                ...
                                entity.Pull(potencyValue, pullImpactPoint, float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousAltProperty));
                                break;
                        case "GravitateToOriginator":
                                ...
                                entity.GravitateToOriginator(Originator, potencyValue, originatorSize, float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousAltProperty));
                                break;
                        ...
                        case "GravitateToProjectile":
                                ...
                                float projectileSize = float.Parse(this.miscellaneousAltProperty);
                                ...
                                entity.GravitateToProjectile(destination, potencyValue, projectileSize, Random.Range(-float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousProperty)), Random.Range(-projectileSize, projectileSize));
                                break;
                        ...
                        case "ExplosiveForce":
                                ...
                                entity.ExplosionForce(potencyValue, explosionImpactPoint, float.Parse(this.miscellaneousProperty), float.Parse(this.miscellaneousAltProperty));
                                break;
                        case "ToggleHover":
                        ...
                        case "EquipWeaponByID":
                                // Effect:will equip a weapon
                                // PotencyValue: ID of the weapon to equip
                                // Misc Property:(Boolean) If true then quick toggle will be applied, equipping the weapon instantly
                                entity.EquipWeapon((int)potencyValue, bool.Parse(this.miscellaneousProperty));
                                break;
                        ...
                        case "EnableWeapon":
                                ...
                                entity.EnableWeapon((int)potencyValue, bool.Parse(this.miscellaneousProperty));
                                break;
                        ...
                        case "DisableWeapon":
                                ...
                                // PotencyValue: ID of the weapon to disable
                                entity.DisableWeapon((int)potencyValue);
                                break;
                        ...
                        case "AdjustWeaponAmmo":
                                ...
                                entity.AdjustWeaponAmmo(int.Parse(this.miscellaneousProperty), (int)potencyValue);
                                break;
    ...
    /// <param name="Target">Target entity which will recieve the effect</param>
    /// <param name="Originator">Originator who activated the ability which is now activating effects</param>
    public void Deactivate(ABC_IEntity Target, ABC_IEntity Originator) {
        ...
        foreach (ABC_IEntity entity in entitiesToActivateOn) {
            ...
            ABC_Utilities.mbSurrogate.StartCoroutine(this.ActivateTextGraphic(entity, EffectAction.Remove, Originator));


            // add to effect log 
            this.LogEffectText(entity, EffectAction.Remove, Originator);
            ...
            if (this.eventType == EffectEventType.Standard || this.eventType == EffectEventType.BothSimultaneously) {
                ...
                switch (this.effectName.Trim()) {
                    ...
                    case "DisableWeapon":
                        // Effect: will disable a Weapon
                        // PotencyValue: ID of the weapon to disable
                        entity.EnableWeapon((int)potencyValue);
                        break;
                    case "DisableWeaponByName":
                        // Effect: will disable a Weapon
                        // MiscValue: Name of the weapon to enable
    ...
    private string ReplacePlaceHolders(string Text, ABC_IEntity Target, ABC_IEntity Originator = null) {
        ...
        Text = Text.Replace("#Potency#", Mathf.Abs(this.CalculatePotencyValue(Target, Originator)).ToString()); // always return the positive number (ABC takes 70 damage)
        Text = Text.Replace("#Ability#", this.abilityName);
    ...
    private IEnumerator ActivateGraphic(ABC_IEntity Target,  Vector3 HitPoint = default(Vector3)) {
        ...
        if (HitPoint != Vector3.zero && this.effectOnHitPosition == true){
                ...
                Vector3 nearestBone = ABC_Utilities.GetClosestBoneFromPosition(Target, HitPoint).position;
                graphicObj.transform.position = nearestBone;     
    ...
    /// <param name="Originator">(Optional) the originator who activated the ability which is now applying effects</param>
    private IEnumerator ActivateTextGraphic(ABC_IEntity Target, EffectAction Action, ABC_IEntity Originator = null) {
        ...
        switch (Action) {
            case EffectAction.Add:
                ...
                text = this.ReplacePlaceHolders(this.effectText, Target, Originator);
            ...
            case EffectAction.Remove:
                ...
                text = this.ReplacePlaceHolders(this.removeEffectText, Target, Originator);
    ...
    private float CalculatePotencyValue(ABC_IEntity Target, ABC_IEntity Originator) {
        ...
        //Keep the potency in the right minus/positive i.e if -70 adjust health + 80 defence would heal for 10  
