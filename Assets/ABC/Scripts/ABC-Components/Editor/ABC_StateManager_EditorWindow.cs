...
public class ABC_StateManager_EditorWindow : EditorWindow {
    [MenuItem("Window/ABC/State Manager")]
    ...
    public int effectWatcherToolbarSelection; 
    ...
    void OnFocus() {
        ...
        if (sel != null && sel.GetComponent<ABC_StateManager>() != null) {
            ...
            GUIContent titleContent = new GUIContent(sel.gameObject.name + "'s ABC State Manager");
        ...
        if (stateManager != null) {
            ...
            switch ((int)toolbarABCSelection) {
                    ...
                    switch ((int)generalSettingsToolbarSelection) {
                        case 0:
                            ...
                            if (GUILayout.Button(new GUIContent(ImportIcon, "Load Default"), textureButton, GUILayout.Width(20)) && EditorUtility.DisplayDialog("Load Default", "Loading defaults will overwrite the current property value. Are you sure you want to continue? ", "Yes", "No")) {
                                ...
                                Text txt = GameObject.Find("ABC_GUIs").GetComponentsInChildren<Text>(true).Where(i => i.name == "txtEffectLog").FirstOrDefault();
                        ...
                        case 1:
                            ...
                            EditorGUILayout.PropertyField(GetTarget.FindProperty("healthIntergrationType"), GUILayout.Width(280));
                            ...
                            if (((string)GetTarget.FindProperty("healthIntergrationType").enumNames[GetTarget.FindProperty("healthIntergrationType").enumValueIndex]) == "ABC")
                            {
                                ...
                                EditorGUILayout.PropertyField(GetTarget.FindProperty("healthABC"), new GUIContent("Current Health"), GUILayout.Width(200));
                            } else if (((string)GetTarget.FindProperty("healthIntergrationType").enumNames[GetTarget.FindProperty("healthIntergrationType").enumValueIndex]) == "GameCreator") {
                                EditorGUILayout.PropertyField(GetTarget.FindProperty("gcHealthID"), new GUIContent("GC Health ID"), GUILayout.Width(200));
                            }
                            ...
                            for (int i = 0; i < meHealthList.arraySize; i++) {
                                ...
                                if (GUILayout.Button(new GUIContent(ImportIcon, "Load Default"), textureButton, GUILayout.Width(20)) && EditorUtility.DisplayDialog("Load Default", "Loading defaults will overwrite the current property value. Are you sure you want to continue? ", "Yes", "No")) {
                                    ...
                                    Text txt = GameObject.Find("ABC_GUIs").GetComponentsInChildren<Text>(true).Where(n => n.name == "txtHealthValue").FirstOrDefault();
                        ...
                        case 2:
                            ...
                            for (int n = 0; n < meHitAnimations.arraySize; n++) {
                                ...
                                SerializedProperty hitAnimationRunnerClip = MyHitAnimationRef.FindPropertyRelative("hitAnimationRunnerClip");
                                ...
                                EditorGUILayout.PropertyField(hitAnimationName, new GUIContent("Name"));
                                ...
                                InspectorHelpBox("animation and graphic which activates when the ability group is enabled");

                                EditorGUILayout.PropertyField(hitAnimationRunnerClip, new GUIContent("Animation Clip"), GUILayout.MaxWidth(315));

                                if (hitAnimationRunnerClip.FindPropertyRelative("refVal").objectReferenceValue != null) {
                                    EditorGUILayout.Space();
                                    EditorGUIUtility.labelWidth = 75;
                                    ...
                                    EditorGUILayout.PropertyField(hitAnimationRunnerInterruptCurrentAnimation, new GUIContent("Interrupt Current Animation"));
                                }

                                InspectorHelpBox("Select an animation clip to play, the duration, speed and delay. The clip is played using the ABC animation runner and does not use Unity's Animator." +
                                    " If Interrupt Current Animation is false then the hit animation will never interrupt another animation currently playing (like an attack)");
                ...
                case 1:
                    ...
                    effectWatcherToolbarSelection = GUILayout.SelectionGrid(effectWatcherToolbarSelection, effectWatcherToolbar, 1);
                    ...
                    switch ((int)effectWatcherToolbarSelection) {
                        case 0:
                            ...
                            foreach (ABC_IEntity key in stateManager.ActiveEffects.Keys) {
                                ...
                                foreach (ABC_StateManager.ActiveEffect effect in stateManager.ActiveEffects[key]) {
                                    ...
                                    EditorGUILayout.LabelField(effect.effect.effectName + " from " + effect.effect.abilityName + " - duration of effect: " + effect.effect.effectDuration);
